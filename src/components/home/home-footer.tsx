  ...
  return (
    <footer className="home-footer">
      ...
      <div className="home-footer-grid">
        ...
        <div className="home-footer-social"><h3>Follow Us</h3><div><a href={company.facebookUrl} target="_blank" rel="noreferrer" aria-label="Follow GRIMM PUMP on Facebook" data-event="facebook_click"><Facebook /></a></div><span>A SAFER WORLD<br />THROUGH<br />RELIABLE FIRE PROTECTION</span></div>
      </div>
