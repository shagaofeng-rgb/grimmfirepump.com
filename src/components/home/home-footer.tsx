  ...
  return (
    <footer className="home-footer">
      ...
      <div className="home-footer-grid">
        ...
        <div className="home-footer-social"><h3>Follow Us</h3><div><a href={company.facebookUrl} target="_blank" rel="noreferrer" aria-label="Follow GRIMM PUMP on Facebook" title="Facebook" data-event="facebook_click"><FacebookIcon /></a><a href={company.youtubeUrl} target="_blank" rel="noreferrer" aria-label="Watch GRIMM PUMP on YouTube" title="YouTube" data-event="youtube_click"><YouTubeIcon /></a><a href={company.whatsappUrl} target="_blank" rel="noreferrer" aria-label="Contact GRIMM PUMP on WhatsApp" title="WhatsApp" data-event="whatsapp_click" data-whatsapp-account="grimm-main" data-whatsapp-placement="home_footer_social"><WhatsAppIcon /></a></div><span>A SAFER WORLD<br />THROUGH<br />RELIABLE FIRE PROTECTION</span></div>
      </div>
